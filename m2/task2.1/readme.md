...
The most popular hypervisors are **Virtual Box**, **VMware Workstation** and **Microsoft Hyper-V**.
...
<img src="./screenshots/1.4.1.png" width="700" height="700">

<p>Here it is up and running:</p>

<img src="./screenshots/1.4.2.png" width="1500" height="700">

<p>Next step is cloning virtual machine.</p>

<img src="./screenshots/1.5.png" width="700" height="700">

<p>Grouped them up to apply different commands or changes simultaneously.</p>

<img src="./screenshots/1.6.png" width="700" height="700">
...
<img src="./screenshots/1.7.png" width="1500" height="700">

<p>I exported first VM and created .ova file, which stands for Open Virtual Appliance.</p>

<img src="./screenshots/1.8.1.png" width="700" height="700">

<p>Then, I imported newmade file into new guest OS.</p>

<img src="./screenshots/1.8.2.png" width="700" height="700">
...
<img src="./screenshots/2.2.1.png" width="700" height="700">

<p>Here you can see it in my guest OS.</p>

<img src="./screenshots/2.2.2.png" width="1500" height="700">

<p>I created shared folder to exchange files between host and guest.<br>
Option <code>--automout</code> just automatically mounts shared folder on OS startup.
</p>
...
<img src="./screenshots/2.3.2.png" width="1500" height="700">
